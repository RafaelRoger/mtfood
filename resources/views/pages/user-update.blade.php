                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Actualize o utilizador</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div>
                            <div class="form-group">
                                <div class="profile-img-edit position-relative">
                                    <img class="img-fluid avatar avatar-100 avatar-rounded"
                                        src="{{ __(!empty($user->profile_photo_path) ? $user->profile_photo_path : url('assets/images/avatars/01.png')) }}" alt="profile-pic">
                    ...
                    <div class="card-body">
                        <div class="new-user-info">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                            value="{{ __($user->name) }}" id="fname" placeholder="First Name">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-label" for="lname">Ultimo Nome:</label>
                                        <input type="text" class="form-control" name="last_name"
                                            value="{{ __($user->last_name) }}" id="lname" placeholder="Last Name">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="email">Email:</label>
                                        <input type="email" class="form-control" name="email"
                                            value="{{ __($user->email) }}" id="email" placeholder="Email">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-label" for="mobno">Telefone:</label>
                                        <input type="text" class="form-control" name="phone1"
                                            value="{{ __($user->phone1) }}" id="mobno" placeholder="Número de telefone">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-label" for="altconno">Telefone alternativo:</label>
                                        <input type="text" class="form-control" name="phone2"
                                            value="{{ __($user->phone2) }}" id="altconno"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="form-label" for="pass">Senha Antiga:</label>
                                        <input type="password" class="form-control" name="old_password" id="pass"
                                            placeholder="Senha antiga">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-label" for="rpass">Nova Senha:</label>
